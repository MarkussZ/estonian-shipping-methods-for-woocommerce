...
/**
 * CircleK shipping method
 *
 * @class     WC_Estonian_Shipping_Method_CircleK
 * @extends   WC_Shipping_Method
 * @category  Shipping Methods
 * @package   Estonian_Shipping_Methods_For_WooCommerce
 */
abstract class WC_Estonian_Shipping_Method_Circlek extends WC_Estonian_Shipping_Method_Terminals
{
    /**
     ...
     * @var string
     */
    public $terminals_file = WC_ESTONIAN_SHIPPING_METHODS_INCLUDES_PATH . "/files/circlek.json";
    ...
    public function __construct() {
        $this->terminals_template = 'circlek';
